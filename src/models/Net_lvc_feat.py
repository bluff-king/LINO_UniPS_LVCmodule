...
class NetLVC_Feat(nn.Module):
    ...
    def forward(self, data, decoder_resolution, canonical_resolution):
        ...
        # ------------------------------------------------------------------
        # Pixel sampling (unchanged from baseline)
        # ------------------------------------------------------------------
...
class LINO_UniPS_LVC_FeatModule(pl.LightningModule):
    """Lightning wrapper for NetLVC_Feat (Version B)."""
