...
class NetLVC_Full(nn.Module):
    """LiNo-UniPS + full LVC module (Version C — proposed method)."""
    ...
    def forward(self, data, decoder_resolution, canonical_resolution):
        ...
        for b in range(B):
            ...
            for ids in idset:
                ...
                lvc_weights_list.append(lvc_w_flat[ids])
...
class LINO_UniPS_LVC_FullModule(pl.LightningModule):
    """Lightning wrapper for NetLVC_Full (Version C — proposed method)."""
